...
public class VendorController {
    ...
    public ResponseEntity<Vendor> getVendorByVendorId(@PathVariable Long vendorId){
    ...
    public ResponseEntity<Vendor> updateVendor(@PathVariable Long vendorId, @RequestBody Vendor updatedVendor){
